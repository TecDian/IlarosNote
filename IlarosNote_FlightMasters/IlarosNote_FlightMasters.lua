---------------------------------------------------------
-- Addon declaration
IlarosNote_FlightMasters = LibStub("AceAddon-3.0"):NewAddon("IlarosNote_FlightMasters", "AceEvent-3.0")
local HFM = IlarosNote_FlightMasters
local Astrolabe = DongleStub("Astrolabe-0.4")
local L = LibStub("AceLocale-3.0"):GetLocale("IlarosNote_FlightMasters", false)
local G = {}
...
do
	...
	local HFM_Dropdown = CreateFrame("Frame", "IlarosNote_FlightMastersDropdownMenu")
...
function HFM:OnInitialize()
	-- Set up our database
	self.db = LibStub("AceDB-3.0"):New("IlarosNote_FlightMastersDB", defaults)
	db = self.db.profile
...
function G:DrawLine(C, sx, sy, ex, ey, w, color, layer)
	...
	T:SetTexture("Interface\\AddOns\\IlarosNote_FlightMasters\\line")
