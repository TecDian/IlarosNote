----------------------------------------------------------------------------
-- IlarosNote
-- Modul für den Notizeditor
----------------------------------------------------------------------------

-- Modul-Deklaration
local IlarosNote = LibStub("AceAddon-3.0"):GetAddon("IlarosNote")
local HN = IlarosNote:GetModule("IlarosNote")
...
-- For jncl (Skinner), this frame is accessed by LibStub("AceAddon-3.0"):GetAddon("IlarosNote"):GetModule("IlarosNote").HNEditFrame
...
HNEditFrame.descscrollframe = CreateFrame("ScrollFrame", "IlarosNote_EditScrollFrame", HNEditFrame.descframe, "UIPanelScrollFrameTemplate")
...
HNEditFrame.icondropdown = CreateFrame("Frame", "IlarosNote_IconDropDown", HNEditFrame, "UIDropDownMenuTemplate")
...
HNEditFrame.icondropdown.text = IlarosNote_IconDropDownText
...
HNEditFrame.leveldropdown = CreateFrame("Frame", "IlarosNote_LevelDropDown", HNEditFrame, "UIDropDownMenuTemplate")
...
HNEditFrame.leveldropdown.text = IlarosNote_LevelDropDownText
