...
-- Modul-Deklaration
IlarosNote_Vendor = LibStub("AceAddon-3.0"):NewAddon("IlarosNote_Vendor","AceEvent-3.0")
local HV = IlarosNote_Vendor
...
local HV_Dropdown = CreateFrame("Frame", "IlarosNote_VendorDropdownMenu")
...
function HV:OnInitialize()
	-- Set up our database
	db = LibStub("AceDB-3.0"):New("NoteVendors", defaults)
	self.db = db

	if db.factionrealm.dbversion > CURRENT_DB_VERSION then
		print("|cff6fafffIlarosNote_Vendor:|r |cffff4f00Warning:|r Unknown database version. Please update to newer version.")
		print("|cff6fafffIlarosNote_Vendor:|r |cffff4f00Warning:|r Addon has been disabled to protect your database.")
		self:Disable()
		return
	end
