...
---------------------------------------------------------
-- Addon declaration
IlarosNote_CityGuide = LibStub("AceAddon-3.0"):NewAddon("IlarosNote_CityGuide","AceEvent-3.0")
local HC = IlarosNote_CityGuide
local Astrolabe = DongleStub("Astrolabe-0.4")
local L = LibStub("AceLocale-3.0"):GetLocale("IlarosNote_CityGuide")
...
local HC_Dropdown = CreateFrame("Frame", "IlarosNote_CityGuideDropdownMenu")
...
function HC:OnInitialize()
	-- Set up our database
	db = LibStub("AceDB-3.0"):New("IlarosNote_CityGuideDB", defaults)
	self.db = db

	if db.factionrealm.dbversion > CURRENT_DB_VERSION then
		print("|cff6fafffIlarosNote_CityGuide:|r |cffff4f00Warning:|r Unknown database version. Please update to newer version.")
		print("|cff6fafffIlarosNote_CityGuide:|r |cffff4f00Warning:|r Addon has been disabled to protect your database.")
		self:Disable()
		return
	end
